function createDataset(fields, constraints, sortFields) {
	...
	var campos = new Array("IDOBJOF", "IDTIPOOBJ", "IDHISTINDICADOR");
	...
	var c4 = DatasetFactory.createConstraint("IDOBJOF", constraint,
	...
	if (datasetRM == null || datasetRM == undefined) {
		...
		for (var i = 0; i < datasetRM.rowsCount; i++) {
			...
			dataset.addRow(new Array(IDOBJOF, IDTIPOOBJ, IDHISTINDICADOR));
		}
