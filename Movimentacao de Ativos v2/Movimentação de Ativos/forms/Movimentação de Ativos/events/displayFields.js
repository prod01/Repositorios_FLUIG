...
function formataCampos(form, customHTML) {
	...
	if (atividade != "0" && atividade != "4"){
		...
		form.setEnabled("ALTURATORRE", false);
	...
	if (atividade != "16"){
		customHTML.append("<script>$('#MOBILIZACAOACEITEDESTINATARIO').attr('readonly', 'readonly');</script>");
		customHTML.append("<script>$('#MOBILIZACAOOSREMETENTEDEST').attr('readonly', 'readonly');</script>");
		
		form.setEnabled("MOBILIZACAOOBSDESTINATARIO", false);
	}
	...
	if (atividade != "54"){
		...
		customHTML.append("<script>$('#CHECKLISTOSGESTORENTR').attr('readonly', 'readonly');</script>");
