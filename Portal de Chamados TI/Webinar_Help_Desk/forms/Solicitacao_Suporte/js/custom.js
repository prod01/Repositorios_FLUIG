...
function setSelectedZoomItem(selectedItem) { 
	...
	if (selectedItem.inputId == "TRANSFERECHAMADO"){
		...
		try{
			var dataset = DatasetFactory.getDataset("ds_tipo_solicitacoes", null, constraints, null);
...
function trocaOpcoes(){
	...
	//pega as options do selct  e nos prociximos ifs
		...
		var acesso0 = new Option("","");
		var acesso1 = new Option("Desenvolvimento / Ajustes", "Desenvolvimento / Ajustes");
		var acesso2 = new Option("Suporte / Parametrização", "Suporte / Parametrização");
		...
		var acesso4 = new Option("Folha de Ponto - Suporte / Parametrização", "Folha de Ponto - Suporte / Parametrização");
