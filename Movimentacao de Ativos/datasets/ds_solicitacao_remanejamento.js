function createDataset(fields, constraints, sortFields) {
	...
	var campos = new Array("IDFLUIG", "SOLICITANTE");
	...
	var c4 = DatasetFactory.createConstraint("NUMERO", descricao,
	...
	if (datasetRM == null || datasetRM == undefined) {
		...
		for (var i = 0; i < datasetRM.rowsCount; i++) {
			var IDFLUIG = datasetRM.getValue(i, "IDFLUIG");
			var SOLICITANTE = datasetRM.getValue(i, "SOLICITANTE");
			dataset.addRow(new Array(IDFLUIG, SOLICITANTE));
		}
