...
function getQuery(OBJETODEMANUTENCAO){
	...
	\
		LEFT OUTER JOIN (SELECT CODCOLIGADA,IDOBJOF,TIPOPREV  FROM OFOBJOFICINACOMPL (NOLOCK)) AS OFOBJOFICINACOMPL\
	ON (OFOBJOFICINA.CODCOLIGADA = OFOBJOFICINACOMPL.CODCOLIGADA AND OFOBJOFICINA.IDOBJOF = OFOBJOFICINACOMPL.IDOBJOF)\
	\
